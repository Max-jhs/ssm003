    ...
    <script>
        $(function () {
            ...
            $.get("${pageContext.request.contextPath}/dept/showDepts.action", function (resultObject) {
                ...
                var $deptSel = $("#deptSel");
                $deptSel.append("<option  value=''>请选择部门</option>")
                $.each(depts,function (i, empDeptId) {
                    $deptSel.append("<option value='" + empDeptId.deptId +"'>" + empDeptId.deptName + "</option>")
                });
            }, "json");
...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form method="post" class="form-x" action="${pageContext.request.contextPath}/emp/addEmp.action"
